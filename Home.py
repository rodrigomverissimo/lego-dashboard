...
with st.spinner('Loading...'): #🛑 Code to create a spinner whenever this metric is being calculated
    #👇 Paste the code created in activity X.Y to calculate the number of new master themes.  
...
with st.spinner('Loading...'):
    #👇 Paste the code created in activity X.Y to calculate the number of new themes.  
...
with st.spinner('Loading...'):
    #👇 Paste the code created in activity X.Y to calculate the number of new sets.  
...
with st.spinner('Loading...'):
    #👇 Paste the code created in activity X.Y to calculate the number of parts of the new sets.  
    #New Sets (considering first year of appearance)
...
#👇 Create an expander container widget with title "New Sets of the Top Master Themes". Bonus Task: make sure that the value of filt_n_themes appears between "Top" and "Master Themes".
#👇 You can find the documentation here - https://docs.streamlit.io/library/api-reference/layout/st.expander
with st.expander(f"New Sets of the Top {filt_n_themes} Master Themes",expanded=True): #Your code here
    with st.spinner('Loading...'):
        ...
        #👇 Paste the code created in activity X.Y to produce a DataFrame with the top N Master Themes as measured by number of new sets.
        ...
        #👇 Paste the code created in activity X.Y to create the visualization of the sets_per_parent_theme DataFrame
...
with st.expander(f"New Sets of the Top {filt_n_themes} Master Themes over the Years",expanded=True):
    ...
    with st.spinner('Loading...'):
        #👇 Paste the code created in activity X.Y to produce a DataFrame with the number of new Sets per Year by Master Theme.
        ...
        #👇 Paste the code created in activity X.Y to create the visualization of the sets_per_year_master_theme DataFrame
...
with st.expander("Largest Lego Set per Year",expanded=True):
    #👇 Create spinner that displays "Loading..." while running
    with st.spinner('Loading...'):
        #👇 Paste the code created in activity X.Y to produce a DataFrame with the largest Set per Year and with Master Theme information.
        ...
        #👇 Paste the code created in activity X.Y to create the visualization of the largest_set_year DataFrame
...
with st.expander("Free Table Explorer",expanded=True):
    #👇 Create spinner that displays "Loading..." while running
    with st.spinner('Loading...'):
        #👇 Paste the code created in activity X.Y to produce a DataFrame with details to year, parent_theme_name, theme_name, set_name and num_parts.
