...
#👇 Create an expander container widget with title "Theme Explorer Sunburst".
with st.expander("Theme Explorer Sunburst",expanded=True):
    #👇 Create spinner that displays "Loading..." while running
    with st.spinner('Loading...'):
        #👇 Paste the code created in activity X.Y to produce a list of parent themes
        ...
        #👇 Paste the code created in activity X.Y to produce the df_sunburst DataFrame
        ...
        #👇 Paste the code created in activity X.Y to create the visualization of the df_sunburst DataFrame
...
#Table Explorer
#👇 Create an expander container widget with title "Theme Explorer Table".
with st.expander("Theme Explorer Table",expanded=True):
    #👇 Create spinner that displays "Loading..." while running
    with st.spinner('Loading...'):
        #👇 Paste the code created in activity X.Y to produce a DataFrame with details 'parent_theme_name','theme_name',
        #                                                                              'year','set_num',
        #                                                                              'set_name','num_parts',
        #                                                                              'part_num','part_name',
