...
with st.container():
    ...
    col1, col2 = st.columns(2)
    #👇Print a string with 'With the ACF and PACF you should have hints to the hyperparameters that could be used on the ARIMA.' using the text method.
    ...
    #👇Save the fig_arima figure using the same method you applied in 4.2. Save as "arima_forecast.png"
